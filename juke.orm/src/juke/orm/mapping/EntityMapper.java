...
{
    public abstract Object readValue(T entity, FieldMap fieldMap) throws JukeException;

    public abstract void writeValue(T entity, Object value, FieldMap fieldMap) throws JukeException;

    public void bindToEntity(EntityContent content, T entity) throws JukeException
	{
		for(FieldMap fm: map.getFieldMaps())
		    writeValue(entity,content.getFieldValue(fm.getIndex()),fm);
	}

	public void bindToContent(T entity, EntityContent content) throws JukeException
	{
		for(FieldMap fm: map.getFieldMaps())
        {
