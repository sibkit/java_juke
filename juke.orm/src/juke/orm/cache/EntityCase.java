...
public class EntityCase
{
	...
	public void putSnapShoot(EntityPutAction putAction, Object savePoint) throws JukeException
	{
		putSnapShoot(putAction,savePoint,getSnapShot().getEntity());
	}

	public void putSnapShot(EntityPutAction putAction) throws JukeException
	{
		putSnapShoot(putAction,null);
	}

	public void putSnapShoot(EntityPutAction putAction, Object savePoint, Object entity) throws JukeException
	{
	...
	private EntityOperationType calculateExecuteAction(EntityPutAction putAction) throws JukeException
	{
		...
		switch (putAction)
		{
			case INSERT:
				...
				throw new JukeException("Invalid put action INSERT on "+prevAction);
			case DELETE:
			...
			case LOAD:
				if(prevAction==null)
					...
					throw new JukeException("Invalid put action LOAD on "+prevAction);
			case REMOVE:
				return null;
			case SAVE:
				return prevAction;
			default:
				throw new JukeException("Invalid put action "+putAction);
		}
	}
}
