...
import juke.orm.mapping.EntityKey;
...
public class Repository
{
	...
	public void merge(Repository repository) throws JukeException
	{
		throw new JukeException("Not implemented");
	}

	public void save(Object savePoint) throws JukeException
	{
	...
	public Object get(Class entityClass, EntityKey entityKey) throws JukeException
	{
	...
	public List list(Query query) throws JukeException
	{
	...
	public <T> Iterator<T> iterate(Query query) throws JukeException
	{
		StorageIterator si;
